	...
	<div class="col-md-20 ">
				<div class="panel panel-default">
					<div class="panel-heading">Menu</div>
							<ul>
							  <li><a href="{{ route('ecampus.inicio.index') }}">Inicio</a></li>
							  <li><a href="{{ route('ecampus.asignaturas.index') }}">Asignaturas</a></li>
							  <li><a href="{{ route('ecampus.estudiantes.index') }}">Estudiantes</a></li>
							  <li><a href="{{ route('ecampus.docente.index') }}">Docentes</a></li>
							  <li><a href="{{ route('ecampus.funcionario.index') }}">Funcionarios</a></li>
