						...
						{!! Form::label('docente_id','Docente Encargado') !!}
						  {!! Form::select('docente_id', $docente, null, array('class' => 'form-control')) !!}
						   ...
						   <div class="form-group">
						    ...
						    {!! Form::number('semestre', null, ['class'=>'form-control', 'placeholder'=>'Semestre al que Corresponde']) !!}
						  </div>
						  <div class="form-group">
						    {!! Form::label('anio','Año del Curso') !!}
						    {!! Form::number('anio', null, ['class'=>'form-control', 'placeholder'=>'Seleccione Año del Curso']) !!}
						  </div>
						  <div class="form-group">
						    {!! Form::label('seccion','Sección a la que Corresponde') !!}
						    {!! Form::number('seccion', null, ['class'=>'form-control', 'placeholder'=>'Seleccione la Sección del Curso']) !!}
						  </div>