...
class RolUsuarioController extends Controller {
	...
	public function index()
	{
		...
		return view('admin.rolusuario.index', compact('rolusuario'));
	}
	...
	public function create()
	{
		...
		return view('admin.rolusuario.create')
				->with('rol',$rol);
	}
	...
	public function store()
	{
		...
		return redirect()->route('admin.rolusuario.index');
	}
	...
	public function edit($id)
	{
		...
		return view('admin.rolusuario.edit', compact('rolusuario'))
				->with('rol',$rol);
	}
